/**
 * This factory handles CRUD requests to the backend API, as well as response caching.
 */
angular.module('app').factory('Kong', ['$http', '$q', '$cookies', 'Alert', function($http, $q, $cookies, Alert) {
    ...
    var factory = {
        ...
        checkConfig: function(url, port) {
            ...
            if (!url || !port) {
                ...
                $http.get(url + ':' + port).then(function(response) {
